...
public abstract class SymEntry {
    ...
    public static class VarEntry extends SymEntry {
        ...
        /**
         * Creates a variable entry with the given name (id), location (loc),
         * and a type which is a reference to the type supplied as a parameter
         * (i.e. a ReferenceType with a base type given by parameter t).
         */
    ...
    public static class OperatorEntry extends SymEntry {
        ...
        void extendType(Type operatorType) {
            if (type instanceof Type.IntersectionType intersectionType) {
                /* Extend type by adding operatorType */
                intersectionType.addType(operatorType);
            } else {
