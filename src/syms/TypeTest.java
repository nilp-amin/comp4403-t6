...
public class TypeTest extends TestCase {
    ...
    public void testCoerce() throws IncompatibleTypes {
        ...
        assertTrue("int variable coerces to dereference",
                result instanceof ExpNode.DereferenceNode dereferenceNode &&
                        dereferenceNode.getLeftValue() == ivx);
        result = ist.coerceToType(ix);
        assertTrue("int coerces to sub-range of int",
                result instanceof ExpNode.NarrowSubrangeNode narrowSubrangeNode &&
                        narrowSubrangeNode.getExp() == ix);
        result = it.coerceToType(isx);
        assertTrue("int sub-range coerces to int" + result,
                result instanceof ExpNode.WidenSubrangeNode widenSubrangeNode &&
                        widenSubrangeNode.getExp() == isx);
    }
